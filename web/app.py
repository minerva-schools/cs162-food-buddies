...
def preference():
    if request.method == 'GET' :
        ...
        if request.files['new_img']:
            ...
            filename_db = 'user_'+str(current_user.id)+ext # the filename stored in db
            # save this new file/ replace the target file with the same name
